                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @wwvvwl\
                                  \n\n--------بـدء تتبـع سجـل جـاكثون 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع جـاكثون 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍--------"
                        ...
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𓄂𝑨𝑺𝑯𝑬𝑸 𝑨𝑳𝑺𝑨𝑴𝑻↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/wwvvwl)"
                        text = (
                            "**✘ تقـريـر اشعـار جـاكثون 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار جـاكثون 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 ✘**\n\n "
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𓄂𝑨𝑺𝑯𝑬𝑸 𝑨𝑳𝑺𝑨𝑴𝑻↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/wwvvwl)"
