...
BaqirVP_cmd = (
    ...
    "⪼ قنـاة كلايـش الفحـص @xvwwvl_vars\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @xvwwvl_vars\n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @xvwwvl_vars\n\n"
    ...
    "\n𓆩 [𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/xvwwvl_vars) 𓆪"
)
