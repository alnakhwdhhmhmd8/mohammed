...
async def _(event):
    ...
    rrr1 = await edit_or_reply(event, f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**")
    await asyncio.sleep(1)
    rrr2 = await rrr1.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    rrr3 = await rrr2.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    rrr4 = await rrr3.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    rrr5 = await rrr4.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    rrr6 = await rrr5.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    rrr7 = await rrr6.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    rrr8 = await rrr7.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    rrr9 = await rrr8.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    rrrr10 = await rrr9.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    rrrr11 = await rrrr10.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت جـاكثون . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        rrrr11,
        f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍 🝢 **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n\n"
...
async def _(event):
    ...
    o = stdout.decode()
    OUTPUT = (
        f"**[𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍](tg://need_update_for_some_feature/) - فـارات تنصيبـك هـي:**\n\n\n{o}"
    )
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
...
async def _(event):
    ...
    stdout, stderr = await process.communicate()
    o = stdout.decode()
    OUTPUT = f"**[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍](tg://need_update_for_some_feature/) - سرعـة السيرفـر**\n**- تم حسـاب سرعـة سيرفـر البـوت الخـاص بك :**\n\n{o}"
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
            await event.client.send_file(
...
async def yamenthon(event): # Code By T.me/T_A_Tl
    uname = platform.uname()
    rept = "**- تاريخ تنصيبـك لـ بـوت جـاكثون - 𓆩𝙎𝙊𝙐𝙍𝘾𝞝 𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍𓆪**\n\n"
