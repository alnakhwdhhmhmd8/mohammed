...
async def mybot(): #Code by T.me/T_A_Tl
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"《البوت المساعد من سورس جـاكثون| قناة السورس @YamenThon | مطور السورس @T_A_Tl 》 ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZQ_LOBLOGO = await zq_lo.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس جـاكثون الخاص بك .. بنجاح 🧸♥️**\n**•⎆┊سورس جـاكثون يعمل بنجاح 🎗**\n\n**[تحياتي المطور الاسطوره عاشق الصمت](t.me/T_A_Tl)**",
                buttons=[(Button.url("𝐉𝐀𝐊-𝐀𝐓𝐇𝐎𝐍𓅛✓", "https://t.me/xvwwvl"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
