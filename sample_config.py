...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Ashqalsmt/Source2"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://i.postimg.cc/HsBGV28T/image.jpg"
    )
    ...
    OLDREP_REPO = os.environ.get("OLDREP_REPO", "https://github.com/Ashqalsmt/Source2")
    if OLDREP_REPO and not url(OLDREP_REPO):
        OLDREP_REPO = "https://github.com/Ashqalsmt/Source2"
    OLDREP_REPOBRANCH = os.environ.get("OLDREP_REPOBRANCH", "master")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/Ashqalsmt/Source2")
